...
Box::Box(int id, glm::dvec3 ref, glm::dvec3 color, glm::dvec3 minimum, glm::dvec3 maximum,double len,double refrac,glm::dvec3 specColor,double diffCoeff,double specExp,double k_trans,double k_reflec):Object(id,ref,color,refrac,specColor,diffCoeff, specExp,k_trans,k_reflec){
    side = len;
    minBound = minimum;
    maxBound = maximum; 
}
