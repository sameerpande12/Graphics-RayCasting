...
class Wall:public Object{//working only for walls aligned along x , y , z
    ...
    public:
        Wall(int id,glm::dvec3 minbound, glm::dvec3 maxbound,glm::dvec3 ref,glm::dvec3 color,glm::dvec4 equation,double refrac,glm::dvec3 specColor,double specCoeff,double diffCoeff,double specExp,double k_trans,double k_reflec,int type,bool invisible);
